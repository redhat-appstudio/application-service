...
require (
	...
	github.com/redhat-appstudio/application-service v0.0.0-20221212195502-575fd814c07a
	github.com/redhat-developer/gitops-generator v0.0.0-20221206221355-5678f9139ac8
