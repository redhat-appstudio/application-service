...
func GetResourceFromDevfile(devfileData data.DevfileData, deployAssociatedComponents map[string]string, name, image string) (parser.KubernetesResources, error) {
