...
import (
	...
	gitopsprepare "github.com/redhat-appstudio/application-service/gitops-generator/pkg/gitops/prepare"
...
func TestGenerateInitialBuildPipelineRun(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gitopsConfig := gitopsprepare.GitopsConfig{AppStudioRegistrySecretPresent: !tt.registrySecretMissing}
