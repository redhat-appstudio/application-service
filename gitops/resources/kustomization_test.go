...
func Test_CompareDifferenceAndAddCustomizedPatches(t *testing.T) {
	k := Kustomization{}
	original := []string{"tesing.yaml", "testing2.yaml", "custom.yaml", "custom2.yaml"}
	generated := []string{"tesing.yaml", "testing2.yaml"}
	k.CompareDifferenceAndAddCustomizedPatches(original, generated)
