...
func (a *ComponentAdapter) updateComponentDevfileModel(hasCompDevfileData data.DevfileData, component appstudiov1alpha1.Component) error {

	log := ctrl.LoggerFrom(a.Ctx)
