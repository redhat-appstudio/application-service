...
func (r *ComponentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if component.Status.Devfile == "" {
		...
		if source.GitSource != nil && source.GitSource.URL != "" {
			...
			if hasApplication.Status.Devfile != "" {
				...
				if err := r.generateGitops(&component, gitopsConfig); err != nil {
	...
	if len(component.Status.Conditions) > 0 && component.Status.Conditions[len(component.Status.Conditions)-1].Status == v1.ConditionTrue {
...
func (r *ComponentReconciler) generateGitops(component *appstudiov1alpha1.Component, gitopsConfig gitopsprepare.GitopsConfig) error {
